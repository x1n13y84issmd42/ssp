...
type sspBuilder struct {
	Parser *ssp.SSP
}

func NewBuilder() *sspBuilder {
	return &sspBuilder{
		Parser: ssp.New(),
	}
}

func (builder *sspBuilder) SetFlags(flags []string) *ssp.SSP {
	for _, f := range flags {
...
func TestOneOf(t *testing.T) {
	parserCtor1 := func() *ssp.SSP {
		return ssp.OneOf(
			ssp.Strings("foo", "bar", "qeq"),
			ssp.Strings("one", "two", "three", "four"),
		)
	}
...
func TestRepeat(t *testing.T) {
	ctor1 := func() *ssp.SSP {
		return ssp.Repeat(ssp.String("yolo"), 0, 1)
	}

	ctor2 := func() *ssp.SSP {
		return ssp.Repeat(ssp.OneOf(
			ssp.String("f00"),
			ssp.String("b4r"),
		), 3, 5)
	}
...
func TestCaptureString(t *testing.T) {
	...
	genericTest(t, []TestInput{
		{
			Init: func() *ssp.SSP {
				return ssp.String("yeet").CaptureString(&v)
			},
...
func TestCaptureStringSlice(t *testing.T) {
	...
	genericTest(t, []TestInput{
		{
			Init: func() *ssp.SSP {
				return ssp.String("things").CaptureStringSlice(&v)
			},
...
func TestCaptureInt64(t *testing.T) {
	...
	genericTest(t, []TestInput{
		{
			Init: func() *ssp.SSP {
				return ssp.String("answer").CaptureInt64(&v)
			},
...
func TestCaptureInt64Slice(t *testing.T) {
	...
	genericTest(t, []TestInput{
		{
			Init: func() *ssp.SSP {
				return ssp.String("answer").CaptureInt64Slice(&v)
			},
...
func TestCaptureFloat64(t *testing.T) {
	...
	genericTest(t, []TestInput{
		{
			Init: func() *ssp.SSP {
				return ssp.String("pie").CaptureFloat64(&v)
			},
...
func TestCaptureFloat64Slice(t *testing.T) {
	...
	genericTest(t, []TestInput{
		{
			Init: func() *ssp.SSP {
				return ssp.String("answer").CaptureFloat64Slice(&v)
			},
...
func TestCaptureFloat64Fail(t *testing.T) {
	...
	genericTest(t, []TestInput{
		{
			Init: func() *ssp.SSP {
				return ssp.String("answer").CaptureFloat64(&v)
			},
...
func TestCaptureBool(t *testing.T) {
	...
	genericTest(t, []TestInput{
		{
			Init: func() *ssp.SSP {
				return ssp.String("truth").CaptureBool(&v)
			},
...
func TestCaptureBoolSlice(t *testing.T) {
	...
	genericTest(t, []TestInput{
		{
			Init: func() *ssp.SSP {
				return ssp.String("truthies").CaptureBoolSlice(&v)
			},
